...
class ReportWriter
  ...
  def report_analyses
    ...
    double_space
    self.puts "Sample Size, Mean Percentage Vote for Population Winner, 99% Confidence Interval Width, Lower 99% C.I., Upper 99% C.I., Variance" # this should be obtained from the analyzer or an analysis record
  ...
  def statistics_for(calculated_variable_symbol, sample_size)
    [:mean, :confidence_interval_width, :lower_confidence_limit, :upper_confidence_limit, :variance].collect do |statistic_symbol|
